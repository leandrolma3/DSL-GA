...
# -*- coding: utf-8 -*-
"""
Script de Pos-Processamento - Batch 4 (6 bases Complementares)
Executa analyze_concept_difference.py, generate_plots.py e rule_diff_analyzer.py
para todos os experimentos do Batch 4
"""
...
if IS_COLAB:
    ...
    RESULTS_DIR = BASE_DIR / "experiments_6chunks_phase2_gbml" / "batch_4"
    CONFIG_FILE = BASE_DIR / "configs" / "config_batch_4.yaml"
...
# Lista dos 6 experimentos do Batch 4 (Complementares)
BATCH_4_EXPERIMENTS = [
    "SINE_Abrupt_Simple",
...
def step2_generate_plots():
    ...
    for exp_name in BATCH_4_EXPERIMENTS:
...
def main():
    """Funcao principal"""
    logger.info("="*80)
    logger.info("POS-PROCESSAMENTO BATCH 4 - 6 BASES COMPLEMENTARES")
    logger.info("="*80)
