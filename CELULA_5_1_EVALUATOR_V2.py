# =============================================================================
# CELULA 5.1: Criar CDCMSEvaluator v2.0 (com predicoes individuais)
# =============================================================================
# Esta celula cria e compila o CDCMSEvaluator que salva predicoes por instancia.
# NECESSARIO para a Parte 7 (calculo de metricas por chunk).
# =============================================================================

import subprocess

print("="*70)
print("CELULA 5.1: CRIAR CDCMSEvaluator v2.0")
print("="*70)

# Codigo Java do avaliador
java_evaluator_v2 = '''
/**
 * CDCMSEvaluator v2.0
 *
...
print(f"     Caminho: {evaluator_file}")
...
if compile_result.returncode == 0:
    print("[OK] CDCMSEvaluator compilado com sucesso!")

    # Verificar que o .class foi criado
    class_file = TEST_DIR / 'CDCMSEvaluator.class'
    if class_file.exists():
        print(f"[OK] {class_file.name} criado ({class_file.stat().st_size} bytes)")
else:
    print("[ERRO] Compilacao falhou")
    print(compile_result.stderr[:500])

print()
print("Formato de saida do CDCMSEvaluator v2.0:")
print("  instance,accuracy,prediction,actual")
print("  1,0.500000,0,1")
print("  2,0.750000,1,1")
print("  ...")
