"""
MCMO Baseline Adapter - River Compatible Version

Version using river instead of scikit-multiflow for Google Colab compatibility.
...
# Try to import MCMO with river
try:
    # Use absolute imports for Colab compatibility
    from mcmo.MCMO_river import MCMO, RiverTreeWrapper, RiverADWINWrapper
    MCMO_AVAILABLE = True
...
class MCMOAdapter:
    ...
    def __init__(
        ...
        # Initialize MCMO with river wrappers
        self.mcmo = MCMO(
...
class MCMOEvaluator:
    """Evaluator wrapper for MCMO - River compatible."""
...
if __name__ == "__main__":
    print("MCMO Baseline Adapter (River Compatible)")
    print("=" * 50)

    if not MCMO_AVAILABLE:
        print(f"ERROR: {IMPORT_ERROR}")
        print("\nPlease install dependencies:")
        print("  pip install geatpy river")
    else:
        print("MCMO dependencies available ✓")
        print("\nTo use this adapter:")
        print("  from mcmo.baseline_mcmo_river import MCMOAdapter, MCMOEvaluator")
