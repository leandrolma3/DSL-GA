...
# Adiciona experimentos unified (chunk_500, chunk_1000, chunk_2000) com suporte a penalty
...
UNIFIED_EXPERIMENT_CONFIGS = {
    ...
    # =========================================================================
    # CHUNK 2000 - SEM PENALTY (foco em performance)
    # =========================================================================
    'exp_unified_2000': {
        'chunk_size': 2000,
        'penalty_weight': 0.0,
        'data_source': 'unified',
        'data_dir': 'chunk_2000',
        'results_dir': 'chunk_2000',
        'egis_model_name': 'EGIS',
        'description': 'Unified chunks 2000 (sem penalty)',
        'batches': {
            'batch_1': {
                'base_dir': 'experiments_unified/chunk_2000/batch_1',
                'datasets': [
                    'SEA_Abrupt_Simple', 'SEA_Abrupt_Chain', 'SEA_Abrupt_Recurring',
                    'AGRAWAL_Abrupt_Simple_Mild', 'AGRAWAL_Abrupt_Simple_Severe', 'AGRAWAL_Abrupt_Chain_Long',
            ...
            'batch_2': {
                'base_dir': 'experiments_unified/chunk_2000/batch_2',
                'datasets': [
                    'SEA_Gradual_Simple_Fast', 'SEA_Gradual_Simple_Slow', 'SEA_Gradual_Recurring',
            ...
            'batch_3': {
                'base_dir': 'experiments_unified/chunk_2000/batch_3',
                'datasets': [
            ...
            'batch_4': {
                'base_dir': 'experiments_unified/chunk_2000/batch_4',
                'datasets': [
                    'SINE_Abrupt_Simple', 'SINE_Gradual_Recurring',
                    'LED_Abrupt_Simple',
                    'WAVEFORM_Abrupt_Simple', 'WAVEFORM_Gradual_Simple',
            ...
            'batch_5': {
                'base_dir': 'experiments_unified/chunk_2000/batch_5',
                'datasets': ['Electricity', 'Shuttle', 'CovType', 'PokerHand', 'IntelLabSensors']
            },
            'batch_6': {
                'base_dir': 'experiments_unified/chunk_2000/batch_6',
                'datasets': [
            ...
            'batch_7': {
                'base_dir': 'experiments_unified/chunk_2000/batch_7',
                'datasets': [
    ...
    # =========================================================================
    # CHUNK 2000 - COM PENALTY (foco em interpretabilidade)
    # =========================================================================
    'exp_unified_2000_penalty': {
        'chunk_size': 2000,
        'penalty_weight': 0.1,
        'data_source': 'unified',
        'data_dir': 'chunk_2000',  # Dados sao os mesmos
        'results_dir': 'chunk_2000_penalty',  # Resultados EGIS diferentes
        'egis_model_name': 'EGIS_Penalty',
        'description': 'Unified chunks 2000 (com penalty)',
        'reuse_comparative_from': 'exp_unified_2000',  # Reutiliza modelos comparativos
        'batches': {
            'batch_1': {
                'base_dir': 'experiments_unified/chunk_2000_penalty/batch_1',
                'datasets': [
                    'SEA_Abrupt_Simple', 'SEA_Abrupt_Chain', 'SEA_Abrupt_Recurring',
                    'AGRAWAL_Abrupt_Simple_Mild', 'AGRAWAL_Abrupt_Simple_Severe', 'AGRAWAL_Abrupt_Chain_Long',
                    'RBF_Abrupt_Severe', 'RBF_Abrupt_Blip',
            ...
            'batch_2': {
                'base_dir': 'experiments_unified/chunk_2000_penalty/batch_2',
                'datasets': [
                    'SEA_Gradual_Simple_Fast', 'SEA_Gradual_Simple_Slow', 'SEA_Gradual_Recurring',
                    'STAGGER_Gradual_Chain',
                    'RBF_Gradual_Moderate', 'RBF_Gradual_Severe',
            ...
            'batch_3': {
                'base_dir': 'experiments_unified/chunk_2000_penalty/batch_3',
                'datasets': [
                    'SEA_Abrupt_Chain_Noise', 'STAGGER_Abrupt_Chain_Noise',
                    'AGRAWAL_Abrupt_Simple_Severe_Noise', 'SINE_Abrupt_Recurring_Noise',
                    'RBF_Abrupt_Blip_Noise', 'RBF_Gradual_Severe_Noise',
            ...
            'batch_4': {
                'base_dir': 'experiments_unified/chunk_2000_penalty/batch_4',
                'datasets': [
                    'SINE_Abrupt_Simple', 'SINE_Gradual_Recurring',
                    'LED_Abrupt_Simple',
                    'WAVEFORM_Abrupt_Simple', 'WAVEFORM_Gradual_Simple',
            ...
            'batch_5': {
                'base_dir': 'experiments_unified/chunk_2000_penalty/batch_5',
                'datasets': ['Electricity', 'Shuttle', 'CovType', 'PokerHand', 'IntelLabSensors']
            },
            'batch_6': {
                'base_dir': 'experiments_unified/chunk_2000_penalty/batch_6',
                'datasets': [
                    'SEA_Stationary', 'AGRAWAL_Stationary', 'RBF_Stationary',
                    'LED_Stationary', 'HYPERPLANE_Stationary', 'RANDOMTREE_Stationary'
                ]
            ...
            'batch_7': {
                'base_dir': 'experiments_unified/chunk_2000_penalty/batch_7',
                'datasets': [
                    'STAGGER_Stationary', 'WAVEFORM_Stationary', 'SINE_Stationary',
                    'AssetNegotiation_F2', 'AssetNegotiation_F3', 'AssetNegotiation_F4'
                ]
...
EXPERIMENTS_TO_RUN = [
    # Experimentos unified ja executados (chunk_500, chunk_1000)
    # 'exp_unified_500',           # Chunk 500 sem penalty - JA COMPLETO
    # 'exp_unified_500_penalty',   # Chunk 500 com penalty - JA COMPLETO
    # 'exp_unified_1000',          # Chunk 1000 sem penalty - JA COMPLETO
    # 'exp_unified_1000_penalty',  # Chunk 1000 com penalty - JA COMPLETO

    # Novos experimentos unified (chunk_2000) - FALTA EXECUTAR
    'exp_unified_2000',            # Chunk 2000 sem penalty
    'exp_unified_2000_penalty',    # Chunk 2000 com penalty
