...
# -*- coding: utf-8 -*-
"""
Script de Pos-Processamento - Batch 1 (12 bases)
Executa analyze_concept_difference.py, generate_plots.py e rule_diff_analyzer.py
para todos os experimentos do Batch 1
"""
...
# Lista dos 12 experimentos do Batch 1
BATCH_1_EXPERIMENTS = [
    "SEA_Abrupt_Simple",
    "SEA_Abrupt_Chain",
...
def main():
    """Funcao principal"""
    logger.info("="*80)
    logger.info("POS-PROCESSAMENTO BATCH 1 - 12 BASES ABRUPT")
    logger.info("="*80)
