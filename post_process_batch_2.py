...
# -*- coding: utf-8 -*-
"""
Script de Pos-Processamento - Batch 2 (9 bases Gradual)
Executa analyze_concept_difference.py, generate_plots.py e rule_diff_analyzer.py
para todos os experimentos do Batch 2
"""
...
if IS_COLAB:
    ...
    RESULTS_DIR = BASE_DIR / "experiments_6chunks_phase2_gbml" / "batch_2"
    CONFIG_FILE = BASE_DIR / "configs" / "config_batch_2.yaml"
...
# Lista dos 9 experimentos do Batch 2 (Gradual Fundamentais)
BATCH_2_EXPERIMENTS = [
...
def step2_generate_plots():
    ...
    for exp_name in BATCH_2_EXPERIMENTS:
...
def main():
    """Funcao principal"""
    logger.info("="*80)
    logger.info("POS-PROCESSAMENTO BATCH 2 - 9 BASES GRADUAL")
    logger.info("="*80)
